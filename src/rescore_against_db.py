...
Παίρνει ένα υπάρχον results CSV (π.χ. results_gpt-4o-mini_mysql.csv,
που ήδη περιέχει τη στήλη "generated_sql") και το ξανατρέχει πάνω σε
διαφορετική βάση (π.χ. MariaDB αντί για MySQL).

Γιατί αυτό έχει νόημα: το schema είναι δομικά πανομοιότυπο στο MySQL
και στο MariaDB, άρα το SQL που δεν χρειάζεται να ξαναπαραχθεί --
εκτέλεση στη δεύτερη βάση και συγκρίνουμε ξανά με το gold. Αυτό μας γλιτώνει
από το να ξανακαλέσουμε το ακριβό/αργό LLM δεύτερη φορά, και επιπλέον
είναι πειραματικά πιο καθαρό.
